...
* Prefer statements that describe what the product does. Avoid weak phrasing.

### Be careful with modal verbs

Avoid modal verbs such as can, could, may, might, will, shall, would, should, and must when possible.
...
* Do not overuse words like "easy" and "simple".
