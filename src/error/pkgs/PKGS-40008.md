---
summary: OutSystems Developer Cloud (ODC) package installation fails with OS-PKGS-40008 when another version exists; set replaceApplicationVersion to true.
