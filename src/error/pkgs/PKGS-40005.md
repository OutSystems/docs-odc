---
summary: OS-PKGS-40005 error in OutSystems Developer Cloud (ODC) occurs when conflicting package installations run simultaneously, blocking the new install.
