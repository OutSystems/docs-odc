...
When setting up data interoperability for the first time, the following operations must be performed by a DBA **for each** [O11 environment mapped to an ODC stage](data-interop.md#mapping):
