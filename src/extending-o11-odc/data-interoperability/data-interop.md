...
OutSystems enables you to build ODC applications that can directly consume entities residing in O11 databases via [Data Fabric](../../eap/integration-with-systems/external-databases/intro.md). This allows for secure access to your O11 trusted data - such as Customers, Orders, or Employees - without the need of data migration.
...
Application runtime communication depends on your O11 infrastructure setup:
