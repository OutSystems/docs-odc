...
See the [limitations](data-interop.md#limitations) for exposing O11 entities to ODC.

</div>

The first step to [reuse O11 entities in your ODC apps](data-interop.md) is exposing those entities using the O11 LifeTime console.
...
* Your O11 infrastructure follows the [prerequisites for data interoperability](data-interop.md#prerequisites).
...
If your O11 infrastructure has additional pipelines, you can use the [environment filter](https://www.outsystems.com/tk/redirect?g=9A82CE12-91D7-45F3-9C28-0F2D00A486B4) dropdown to display only the O11 environments of a specific pipeline.
...
When you need the exposed O11 entities available in the next ODC stage, promote the exposed entities to the [corresponding O11 environment](data-interop.md#mapping).
...
1. Click **Promote** to begin the promotion process.
    ...
    * If your O11 infrastructure has additional pipelines, you can use the [environment filter](https://www.outsystems.com/tk/redirect?g=9A82CE12-91D7-45F3-9C28-0F2D00A486B4) on the **Expose entities** screen to dropdown to display only the O11 environments of a specific pipeline.
