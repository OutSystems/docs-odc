---
summary: Mentor Web in OutSystems Developer Cloud (ODC) generates data models, authorization rules, dashboards, and screens, then refines apps through natural language.
tags:
  - AI
  - Authorization
  - Data Model
