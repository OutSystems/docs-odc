...
Emails are an integral part of any app you develop because you can send app users such things as invitations or notifications. An OutSystems app sends emails using SMTP (Simple Mail Transference Protocol). In Project Neo, you configure emails in the Portal.
...
Before apps can send emails, you must create the email in Service Studio.

1. To begin, open the Portal, and from the navigation menu, select **Configurations** > **Emails**. The **Email configurations** page opens.
...
1. Complete the following fields. Required fields display with an asterisk.
      ...
      * **Recipients** -  the email address and name of the people receiving this email. Select **Set in app** to use the email addresses from Service Studio or select **Test List** to display fields to enter email test recipients.
...
1. Open the Portal, and from the left Nav menu, select **Apps**.
...
1. To change an email configuration,  go to the Portal and select **Configurations** > **Email**.
