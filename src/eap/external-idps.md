...
Before you begin configuring an external provider for use in ODC, you need to get the following information from the provider:
...
A ODC admin can configure an external IdP. Navigate to the **Identity providers** tab in ODC Portal. You see listed the built-in provider and any external IdPs already added. Follow these steps:
