---
summary: ODC Identity Service architecture uses JWT and OIDC to broker authentication via IdP, manage token lifecycle, and enforce authorization across Platform and apps.
tags:
  - Architecture
  - Authentication
  - Authorization
