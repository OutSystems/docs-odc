---
helpids: 30635
summary: OutSystems Developer Cloud (ODC) Audit trails ensure compliance, aid troubleshooting, and track platform operations for effective incident response.
tags:
  - Events
  - Logging
  - Monitoring
...
figma: https://www.figma.com/design/IStE4rx9SlrBLEK5OXk4nm/Monitor-and-troubleshoot-apps?node-id=3861-224&p=f&t=UTR7yaSje93yuY9L-0
outsystems-tools:
  - odc portal
coverage-type:
  - remember
...
ODC's Audit trails provide you with a comprehensive, immutable record of significant actions and changes within your environment. They help you monitor security, maintain compliance, and troubleshoot operational issues by clearly showing who did what, where, and when across your platform. Audit trails offer significant advantages:
...
* **Real-time monitoring**: Stream audit logs directly to your SIEM tools for continuous threat detection and centralized security operations.

## Prerequisites

Before you can view or export audit logs, you must have the **Audit Trail View** role.

## View audit trails in the ODC Portal
...
* **Access three months of data**: When you export, you can retrieve logs up to three months old.
...
* **Upload to your SIEM tool**: Upload your audit trail data to your SIEM tool of choice for further analysis.
...
For continuous, automated log delivery to your SIEM tool without manual exports, refer to [Stream audit trail logs](audit-trail-streaming.md).
...
## Stream audit trail logs to SIEM tools

For organizations requiring real-time security monitoring and extended log retention, ODC offers audit trail streaming. This capability allows you to automatically stream audit logs to your preferred SIEM solutions, such as Datadog, Splunk, or AWS Firehose.

With audit trail streaming, you can:

* Receive audit logs in real-time as events occur
* Retain logs beyond the 30-day viewing period and 3-month export limitation
* Integrate ODC audit data with your existing security infrastructure
* Set up automated alerts and anomaly detection
* Eliminate manual CSV export and upload workflows

For more information about setting up and configuring audit trail streaming, refer to [Stream audit trail logs](audit-trail-streaming.md).

## Track auditable events

ODC's Audit trails help you oversee operations critical to data security and operational integrity. ODC tracks the following types of auditable operations. These operations relate to user actions and configurations made in the ODC Portal, ODC Studio, and through OutSystems Public APIs.
...
| **Event_Response_Status** | The outcome of the operation. | **Success**: The operation completed as expected.<br/><br/>**Failed**: The operation started but didn't complete.<br/><br/>**Unknown**: The operation started, but its completion status isn't confirmed (often indicates a system issue). |
