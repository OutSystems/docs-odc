...
figma: https://www.figma.com/design/hdmSs8a8ifLQTmDBJmkJnD/Integration-with-external-systems?node-id=6601-95
audience:
  - mobile developers
  - frontend developers
...
If you have not defined any custom exception handlers in your app, the exception will be handled by the default Global Exception Handler. Check [Exception Handling Mechanism](../../building-apps/handling-exceptions/handling-mechanism.md) for more information.
...
![Error feedback message displayed at the top of the application screen](images/feedback-message-error-odcs.png "Error Feedback Message")
