...
From version 1.1.0, set the **CalendarsUsageDescription** and **CalendarsFullAccessUsageDescription** extensibility settings in your app's detail page in the Portal, under the **Mobile distribution** tab.

If you don't explicitly configure these settings, the default values are used.

For plugin versions earlier than 1.1.0, set iOS permissions in your app's extensibility configurations file, as follows:
...
1. In **ODC Studio**, go to **Logic** > **Client Actions** > **CalendarPlugin**.
