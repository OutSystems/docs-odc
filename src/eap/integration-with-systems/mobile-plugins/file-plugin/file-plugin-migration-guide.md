...
![Example for migrating from DEPRECATED_GetFileUrl to ReadFile, and converting the BinaryData to a Blob URL](images/migration-get-blob-url-odc.png "Use ReadFile action and get a Blob URL")
