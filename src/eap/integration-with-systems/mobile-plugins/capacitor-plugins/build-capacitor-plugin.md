...
figma: https://www.figma.com/design/6G4tyYswfWPn5uJPDlBpvp/Building-apps?node-id=8375-2
coverage-type:
  - understand
  - apply
topic:
...
Capacitor plugins follow a multi-layer architecture that enables web-to-native communication. For detailed information about the architecture, refer to [Capacitor plugin architecture](capacitor-plugin-architecture.md).

Throughout this article, the [Barcode Plugin](https://github.com/ionic-team/capacitor-barcode-scanner/tree/main/plugin) repository serves as an example to demonstrate the plugin development process.
