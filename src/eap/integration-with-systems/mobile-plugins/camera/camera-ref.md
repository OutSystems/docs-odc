...
DEPRECATED, should use the new ChooseFromGallery Client Action instead. The exception being if you're on a PWA, because currently ChooseFromGallery is not available on PWAs.
