...
locale: en-us
guid: 546eb367-db9e-451b-80e8-7f4055f1dcb2
...
Breakpoints can be added to elements of an action flow, except for comment elements.
...
While it is a common practice to add breakpoints before running a app, you may add or remove breakpoints anytime during a debug session.
...
1. Right-click on that element (either in the canvas or in the app tree).
