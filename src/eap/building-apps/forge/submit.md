...
* If it is an external library, it must target a [supported .NET version](../external-logic/upgrade-net.md). The same applies to apps with dependencies on external libraries.
