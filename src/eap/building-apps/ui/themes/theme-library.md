...
!["Create a Library"](images/select-library-ss.png "Create a Library")

!["Specify Library Name, icon and description"](images/library-details-ss.png "Specify Library Name, icon and description")
...
!["Theme is available in Themes folder"](images/themes-folder-ss.png "Theme is available in Themes folder")
...
!["Theme common components are available in Theme common flow"](images/theme-common-flow-ss.png "Theme common components are available in Theme common flow")
...
!["Theme Layouts have all the layouts available to be used by applications"](images/theme-layouts-ss.png "Theme Layouts have all the layouts available to be used by applications")
...
!["Layout placeholders and structure. Adding an ApplicationTitle placeholder"](images/add-applicationtitle-placeholder-ss.png "Layout placeholders and structure. Adding an ApplicationTitle placeholder")
...
!["Placeholder styles properties"](images/placeholder-styles-properties-ss.png "Placeholder styles properties")
...
!["Make theme images public to be used in other applications"](images/select-all-images-ss.png "Make theme images public to be used in other applications")

Select all the items that you want to make public and to be used by other apps.

!["Make all elements public to be used by any application"](images/make-elements-public-ss.png "Make all elements public to be used by any application")
...
!["Create application layout wrappers"](images/application-layout-wrappers-ss.png "Create application layout wrappers")
...
!["Applications layout placeholders structure with common blocks inside placeholders"](images/layout-placeholders-ss.png "Applications layout placeholders structure with common blocks inside placeholders")
...
!["Applications layout placeholders structure with common blocks inside placeholders"](images/layout-placeholders-option1-ss.png "Applications layout placeholders structure with common blocks inside placeholders")
...
!["Applications layout placeholders structure with common blocks inside placeholders"](images/layout-placeholders-option2-ss.png "Applications layout placeholders structure with common blocks inside placeholders")

After setting the layouts, you must set the **App_LayoutTopMenu** in the app theme.

!["In the application theme the application layout is set as default"](images/set-app-layout-top-menu-ss.png "In the application theme the application layout is set as default")
...
!["Global client action available in Theme to clean PH"](images/global-client-action-available-ss.png "Global client action available in Theme to clean PH")

!["How to use the Global client action to clean PH in the layouts"](images/how-to-use-global-client-action-ss.png "How to use the Global client action to clean PH in the layouts")
