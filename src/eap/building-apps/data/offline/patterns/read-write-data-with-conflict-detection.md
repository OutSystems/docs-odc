...
Explore the Forge component [Offline Data Sync Patterns-R/W Conflict Detect](https://www.outsystems.com/forge/component-overview/16953/offline-data-sync-patterns-r-w-conflict-detect-odc), which uses companies as an example for data synchronization to understand more about this pattern. The following sections provide detailed descriptions of the component's data model and logic.
