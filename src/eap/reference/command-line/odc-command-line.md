---
summary: 'ODC Studio command line reference for Windows: -create, -diff, -merge, -refresh, -recover, and -openModuleFromUrl with syntax and arguments.'
locale: en-us
...
![Screenshot of the ODC Studio dialog to create a new application.](images/new-application-odcs.png "Create New Application Dialog")
